...
1. [x] Добавить инструкции по сборке для Windows/Linux в README.
2. [x] Добавить checklist приемки (пункты 1-10 из ТЗ) в отдельный документ.
3. [x] Оформить release-артефакты и версионирование.
