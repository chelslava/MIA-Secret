...
- Sprint B (Качество и тестирование): **закрыт**
...
- [x] При необходимости вынести ожидания схем в snapshot-файлы для более прозрачного diff.
...
1. План закрыт, новые шаги формируются по новым требованиям.
